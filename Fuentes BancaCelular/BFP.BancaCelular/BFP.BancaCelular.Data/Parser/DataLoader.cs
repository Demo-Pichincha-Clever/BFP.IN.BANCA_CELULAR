...
namespace BFP.BancaCelular.Data
{
    public class DataLoader
    {
        ...
        private XmlDataDocument LeerXML(string strNombreTransaccion, string strNombreMensaje)
        {
            ...
            if (File.Exists(ConfigurationManager.AppSettings.Get("XMLPrograma") + "BFP" + strNombreTransaccion + strNombreMensaje + ".xml"))
            {
                document.Load(ConfigurationManager.AppSettings.Get("XMLPrograma") + "BFP" + strNombreTransaccion + strNombreMensaje + ".xml");
                return document;
            }
